...
| GET/products          | Read      | Retrieve all products | 200 (OK), 403 (Forbidden), 404 (Not Found), 401 (Unauthorized) | N/A | `[ { "id": 1, "name": "Product Name", "description": "Product Description", "price": 10.99, "quantity": 100, "supplier_id": 1 } ]` |
| GET/products/{id}     | Read      | Retrieve specific product | 200 (OK), 404 (Not Found), 403 (Forbidden), 401 (Unauthorized) | N/A | `{ "id": 1, "name": "Product Name", "description": "Product Description", "price": 10.99, "quantity": 100, "supplier_id": 1 }` |
...
| GET/inventories          | Read      | Retrieve all inventory items | 200 (OK), 403 (Forbidden), 404 (Not Found), 401 (Unauthorized) | N/A | `[ { "id": 1, "product_id": 1, "quantity_available": 50, "location": "Warehouse A" } ]` |
| GET/inventories/{id}     | Read      | Retrieve specific inventory item | 200 (OK), 404 (Not Found), 403 (Forbidden), 401 (Unauthorized) | N/A | `{ "id": 1, "product_id": 1, "quantity_available": 50, "location": "Warehouse A" }` |
