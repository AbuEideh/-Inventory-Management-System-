...
| PUT/inventories          | Replace   | Replace all inventory items with new collection | 200 (OK), 204 (No Content), 400 (Bad Request) | `[ { "id": 1, "product_id": 1, "quantity_available": 50, "location": "Warehouse A" } ]` | N/A |
...
| DELETE/orders/{id}   | Delete    | Delete specific order | 204 (No Content), 400 (Bad Request) | N/A | N/A |
